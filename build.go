...
func build(pkg string, tags []string) {
	...
	// Create a hash of the binary, to be included in the archive for
	// automatic upgrades.
...
func buildTar() {
	...
	files := []archiveFile{
		...
		{src: "syncthing.sha256", dst: name + "/syncthing.sha256"},
	}
...
func buildZip() {
	...
	files := []archiveFile{
		...
		{src: "syncthing.exe.sha256", dst: name + "/syncthing.exe.sha256"},
	}
